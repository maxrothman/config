...
exports.inputParams = exports.input = exports.WorkflowUpdater = exports.Workflow = exports.dateUtils = exports.utils = exports.http = void 0;
...
var workflow_updater_1 = require("./workflow-updater");
Object.defineProperty(exports, "WorkflowUpdater", { enumerable: true, get: function () { return workflow_updater_1.WorkflowUpdater; } });
/**
 * @description 读取命令参数
 * @deprecated 推荐使用inputParams
 */
exports.input = process.argv[2];
exports.inputParams = process.argv.slice(2);
